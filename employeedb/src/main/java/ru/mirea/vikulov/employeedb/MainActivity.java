...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.findB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (binding.editID.getText().length() != 0) {
                    ...
                    binding.editSal.setText(employee.getSalary());
                } else {
        ...
        binding.saveB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (binding.editID.getText().length() != 0 & binding.editName.getText().length() != 0 & binding.editSal.getText().length() != 0) {
                    try {
                        ...
                        employee.salary = Integer.parseInt(String.valueOf(binding.editSal.getText()));
